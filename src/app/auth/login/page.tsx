...
export default function LoginPge(searchParams: any) {
      ...
      <div className="bg-primary min-h-screen relative w-full">
        ...
        <div className="mt-[69px]">
          <form action="" onSubmit={handleLogin}>
            <div className="px-5 flex flex-col gap-[47.34px] w-full">
              <input
                type="email"
                placeholder="Email"
                id="email"
            ...
            <div className="flex items-center justify-between px-5 mt-[27.2px]">
              ...
              <p className="text-blue-500 ">Forgot password ?</p>
                    ...
                    <div className="flex items-center flex-col w-full mt-[50px] px-[1rem] drop-shadow-lg">
          <button
          ...
          <button
            className="w-full p-2 bg-white rounded-[5px] mt-[15px]"
