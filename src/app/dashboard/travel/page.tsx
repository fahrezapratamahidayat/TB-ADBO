    ...
    <>
      <div className="bg-primary min-h-screen relative w-full">
        <svg
          ...
          viewBox="0 0 375 252"
          fill="none"
          className="absolute top-0 left-0 z-[-99px]"
        >
        ...
        <main className="w-full h-full relative z-10">
          ...
          <div className="w-[55%] flex items-center justify-between ml-5 ">
            ...
            <h1 className="text-[25px] font-bold">Travel Notes</h1>
          </div>
          <div className="px-5">
                  ...
                  >
                    <div className="flex ">
                      <div className="relative w-10 h-10 overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600">
                        {story.profileUrl ? (
                          <Image src={story.profileUrl} alt="" />
                        ) : (
                          <svg
                    ...
                    <div className="bg-white shadow-lg drop-shadow-lg rounded-[2rem] w-full mt-5 px-2 h-[1.76981rem] flex items-center justify-between">
                      ...
                      <div className="flex items-center">
                        <Link
                          href={`/dashboard/travel/${story.id}`}
                          className="flex items-center"
                        >
                          <Image
                            width={20}
                            height={20}
                            src="/src/Images/chat.png"
                            alt=""
                          />
                          <h2 className=""></h2>
                        </Link>
